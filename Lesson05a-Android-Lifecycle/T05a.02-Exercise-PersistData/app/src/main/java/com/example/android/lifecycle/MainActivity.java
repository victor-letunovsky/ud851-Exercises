...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (6) If savedInstanceState is not null and contains LIFECYCLE_CALLBACKS_TEXT_KEY,
        // set that text on our TextView
        if (savedInstanceState != null && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
            CharSequence savedState = savedInstanceState.getCharSequence(LIFECYCLE_CALLBACKS_TEXT_KEY);
            Log.d(TAG, "Restore state: " + savedState);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // ====== BEHAVIOR IS DIFFERENT IF REMOVE .toString() =======
        // Actually this "defect" is described and fixed in another way in T05a3
        CharSequence stateToSave = mLifecycleDisplay.getText().toString();
        Log.d(TAG, "Save state: " + stateToSave);
        outState.putCharSequence(LIFECYCLE_CALLBACKS_TEXT_KEY, stateToSave);
    }
