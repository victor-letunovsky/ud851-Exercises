...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(SEARCH_QUERY_URL_EXTRA)) {
                URL queryUrl = (URL) savedInstanceState.getSerializable(SEARCH_QUERY_URL_EXTRA);
    ...
    private void makeGithubSearchQuery() {
        ...
        queryBundle.putSerializable(SEARCH_QUERY_URL_EXTRA, githubSearchUrl);
    ...
    // Within onCreateLoader
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                URL searchQueryUrl = (URL) args.getSerializable(SEARCH_QUERY_URL_EXTRA);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        try {
            URL queryUrl = new URL(mUrlDisplayTextView.getText().toString());
            outState.putSerializable(SEARCH_QUERY_URL_EXTRA, queryUrl);
        } catch (IOException e) {
            e.printStackTrace();
        }
